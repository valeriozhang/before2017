...
def profiling():
	(img_data, header_data, img_height, img_width) = loadBMPImage( sys.argv[1] ) #sys.argv[1]
	(filter_width, filter_weights) = parseFilterCmdArgs( sys.argv ) #sys.argv
	out_img_data = doConvolution( img_data, filter_width, filter_weights, img_height, img_width )
	saveBMPImage( out_img_data, header_data, sys.argv[2], img_height, img_width ) #sys.argv[2]
